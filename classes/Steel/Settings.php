...
class Settings {
    ...
    public function setup() {
        $this->config['steel'] = [];
        $this->config['steel']['postinst'] = false;
        ...
        $this->config['resources']['css'] = [
            [
                ...
                'sri' => 'sha384-rwoIResjU2yc3z8GV/NPeZWAv56rSmLldC3R/AZzGRnGxQQKnKkoFVhFQhNUwEyJ'
            ]
        ];
        ...
        $this->config['resources']['js'] = [
            ...
            [
                ...
                'sri' => 'sha384-vBWWzlZJ8ea9aCX4pEW3rVHjgjt7zpkNpZk+02D9phzyeVkE+jo0ieGizqPLForn'
            ]
        ];
